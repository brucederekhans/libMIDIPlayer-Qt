...
QMIDI::QMIDIPlaying::QMIDIPlaying(const wchar_t * pFilename, unsigned char AVolumePercentage, unsigned char AIsLoop, QObject * parent) :
    QObject(parent),
    isLoop(AIsLoop),
    isPaused(0),
    isStopRequested(0),
...
unsigned char QMIDI::QMIDIPlaying::getIsLoop()
{
    return this->isLoop;
}
